...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_X = 3.56; // X is the up and down direction
    public static double PARALLEL_Y = .96; // Y is the strafe direction

    public static double PERPENDICULAR_X = -5.93;
    public static double PERPENDICULAR_Y = -1.043;

    public static double X_MULTIPLIER = 0.8223562827; // 0.8223562827
    public static double Y_MULTIPLIER = 0.7880156543;
